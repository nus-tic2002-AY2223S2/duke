...
public class Deadline extends Task
{
    ...
    /**
     * Constructs Deadline task type, has a description (inherited) member and a by member for datetime
    ...
    /**
     * Returns a String for displaying Deadline task
    ...
    /**
     * Returns a LocalDateTime to get the date and time of the particular deadline clas
